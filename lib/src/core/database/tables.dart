...
class Exercises extends Table {
  ...
  TextColumn get secondaryMuscles => text().map(const ListConverter()).nullable()();
  TextColumn get equipment => text().map(const ListConverter()).nullable()(); // e.g. ["Barbell", "Bench"]
  TextColumn get mechanic => text().nullable()(); // e.g. "Compound", "Isolation"
  TextColumn get force => text().nullable()(); // e.g. "Push", "Pull", "Static"
  TextColumn get movementPattern => text().nullable()(); // e.g. "Press", "Fly", "Row"
}
